...
func spawn_cubes() -> void:
	...
	var box = PhysicsServer3D.shape_create(PhysicsServer3D.SHAPE_BOX)
	...
	for i in range(num_cubes):
		...
		cube_array.append(InnerCube.new(PhysicsServer3D.body_create(PhysicsServer3D.BODY_MODE_RIGID, true),i))
