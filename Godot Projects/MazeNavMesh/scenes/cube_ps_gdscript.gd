...
@onready var box = PhysicsServer3D.shape_create(PhysicsServer3D.SHAPE_BOX)
...
func spawn_cubes() -> void:
	...
	var cube : InnerCube = InnerCube.new(PhysicsServer3D.body_create(PhysicsServer3D.BODY_MODE_RIGID, true), mm.visible_instance_count)
